...
SheetNames = ["Step0标幺定点化基准值","Step1仿真参数设定","Step2电机参数设定",...
    "Step3硬件参数设定","Step4控制参数设定","Step5模型控制参数",...
    "Step6定点化模型控制参数","Step7枚举变量","Step8查找表数据","Step9总线信号",...
    "Step10调试观察变量","Step11调试配置","Step12查找表数据"];
...
if(MotorModelType==1)
    ...
    saveChanges(DataDic);
    clear
    open_system("BLAC_MotorCtrl_Math.slx");
else
    ...
    saveChanges(DataDic);
    clear
    open_system("BLAC_MotorCtrl_Physic.slx");
end
